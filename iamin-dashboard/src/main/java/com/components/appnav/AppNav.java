 ...
 * created by adding {@link AppNavItem} instances
 * to other {@link AppNavItem} instances.
 */
...
public class AppNav extends Component implements HasSize, HasStyle {
     ...
     * <p>
     * This can help the end user to distinguish groups of navigation items.
    ...
    private Element getLabelElement() {
        return getExistingLabelElement()
                .orElseGet(() -> {
